...
import {pharmacourses } from "../../../Constants";
...
import Pharmaillusion from "../../assets/image/undraw_medicine_hqqg.svg";
...
export default function Pharma() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-800 transition-colors duration-500">
      ...
      {/* Hero Section */}
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 py-25">
        {/* Left */}
        <motion.div
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white py-10 md:py-0">
            Welcome Future <span className="text-indigo-600">Doctors 🚀</span>
          </h1>
      ...
      <div className="px-4 py-8">
        <h2 className="text-3xl font-bold text-center text-gray-700 mb-10">
          Explore Pharma <span className="text-blue-600">Branches</span>
        </h2>
...
function CourseCard({ course, index, navigate }) {
  ...
  return (
    <motion.div
      ...
      onClick={() => navigate(`/pharma/${course.id}`)}
