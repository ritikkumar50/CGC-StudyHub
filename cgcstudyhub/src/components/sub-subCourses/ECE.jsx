...
const SemesterCard = React.memo(({ sem, navigate }) => {
  ...
  return (
    <motion.div
      ...
      onClick={() => {
        if (sem.id === 1) navigate("/btech/ece/firstsemester");
        else if (sem.id === 2) navigate("/btech/ece/secondsemester");
        else if (sem.id === 3) navigate("/btech/ece/thirdsemester");
        else if (sem.id === 4) navigate("/btech/ece/fourthsemester");
        else if (sem.id === 5) navigate("/btech/ece/fifthsemester");
        else if (sem.id === 6) navigate("/btech/ece/sixthsemester");
        else if (sem.id === 7) navigate("/btech/ece/seventhsemester");
